    ...
    <div class="wrapper">
        ...
        <div class="pull-left info">
          ...
          <ul class="sidebar-menu">
              ...
              <li ><a href="index.php"><i class="fa fa-home sz1"></i><span> &nbsp;Dashboard</span></a></li>
					...
					<li class="active"><a href="pengirimantoko.php"><i class="fa fa-cube text-yellow sz1"></i><span>&nbsp;&nbsp;&nbsp;Pengiriman Ke Toko</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Data Pengiriman ke Toko
          </h1>
          <ol class="breadcrumb">
            <li><i class="fa fa-user-circle-o"></i> Data Pengiriman ke Toko</li>
          </ol>
        </section>
