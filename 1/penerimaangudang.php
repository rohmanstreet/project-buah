    ...
    <div class="wrapper">
        ...
        <div class="pull-left info">
          ...
          <ul class="sidebar-menu">
              ...
              <li ><a href="index.php"><i class="fa fa-home sz1"></i><span> &nbsp;Dashboard</span></a></li>
					...
					<li class="active"><a href="penerimaangudang.php"><i class="fa  fa-truck text-aqua sz1"></i><span>&nbsp;&nbsp;&nbsp;Penerimaan Antar Gudang</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Data Penerimaan Antar Gudang
          </h1>
          <ol class="breadcrumb">
            <li><i class="fa fa-user-circle-o"></i> Data Penerimaan Antar Gudang</li>
          </ol>
        </section>
              ...
              <div class="box">
                ...
                <div class="box-body">
				  <table id="data" class="table table-bordered table-striped table-scalable">
						<?php
							include "dt_penerimaangudang.php";
						?>
                  </table>
