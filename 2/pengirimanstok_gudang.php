    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            pengirimanstokgudang
          </h1>
          <ol class="breadcrumb">
            <li><i class="fa fa-columns"></i> pengirimanstokgudang</li>
          </ol>
        </section>
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
				...
				<tbody>
					<?php
						$qpnsgdg = mysqli_query ($konek, "SELECT * FROM tb_pengirimstokgudang WHERE id_admin=".$_SESSION["id_admin"]."");
						if($qpnsgdg == false){
						...
						while ($respnsgdg = mysqli_fetch_array ($qpnsgdg)){
							...
							echo "
								<tr>
									...
									<td>$respnsgdg[gudang]</td>
									<td>$respnsgdg[jumlah]</td>
									<td>$respnsgdg[tgl]</td>
									<td>
										<a href='#' class='open_modal' id_pgrimgdg='$respnsgdg[id_pgrimgdg]'>Edit</a> |
										<a href='#' onClick='confirm_delete(\"pengirimanstokgudang_delete.php?id_pgrimgdg=$respnsgdg[id_pgrimgdg]\")'>Delete</a>
									</td>
								</tr>";
						}
					?>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Tambah pengirimanstokgudang</h4>
					</div>
					<div class="modal-body">
						<form action="pengirimanstokgudang_add.php" name="modal_popup" enctype="multipart/form-data" method="post">
							<div class="form-group">
								<label>Tanggal Kirim</label>
									<div class="input-group date">
										...
										<input id="tgl_kirim" name="tgl_kirim" type="text" class="form-control" placeholder="Tanggal terima" required>
									</div>
							</div>
							...
							<div class="form-group">
								<label>Di Kirim ke Gudang</label>
									<div class="input-group">
										<div class="input-group-addon">
											<i class="fa fa-user"></i>
										</div>
		...
		<div id="Meditpgirim" class="modal fade" tabindex="-1" role="dialog"></div>
