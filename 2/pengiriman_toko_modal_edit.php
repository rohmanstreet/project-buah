...
$querypengirimanstok_gudang = mysqli_query($konek, "SELECT * FROM tb_pengirimtoko WHERE id_pgrimgdg='$id_pgrimgdg'");
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Edit pengiriman toko</h4>
					</div>
					<div class="modal-body">
						<form action="pengirimanstok_gudang_edit.php" name="modal_popup" enctype="multipart/form-data" method="post">
							<input name="id_pgrimgdg" type="hidden" class="form-control" value="<?php echo $pengirimanstok_gudang["id_kirimtoko"]; ?>">
							...
							<div class="form-group">
								<label>Di Kirim Ke Toko</label>
									<div class="input-group">
										<div class="input-group-addon">
											<i class="fa fa-unlock"></i>
										</div>
										<textarea name="alamat" type="text" class="form-control" ><?php echo $pengirimanstok_gudang["alamat"]; ?></textarea>
									</div>
							</div>
							<div class="form-group">
